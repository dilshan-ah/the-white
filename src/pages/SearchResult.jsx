    ...
    return (
        <>
            ...
            <div className=' container mx-auto px-5 py-20'>
                <p className='poppins font-semibold text-3xl mb-4	capitalize'>Showing results for "{string}"</p>
            </div>
            ...
            <div className='container mx-auto px-5 grid lg:grid-cols-3 grid-cols-2 gap-5'>
